...
// terminal_state is a lambda that takes an argument, and returns another lambda that captures that argument. This innner
...
// lambda takes an argument that it passes to the outer lambdas lambda... Then it calls terminal_state on the result and
// returns its result.
